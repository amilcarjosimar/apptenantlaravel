...
@section('content')
    ...
    border-radius: 4px;background: #e36b6a;">Ver Parametros</a>
                     ...
                     <div class="widget w-action" style="height:90px;border-radius:10px;margin-top:-25px;color:#fff;padding-left: 45px;border-top: 2px solid #fff;padding-top:0px;background: #e36b6a;">
                              <div class="wethear-now inline-items" style="margin-top:0px">
...
<div class="container">
                        ...
                        <a href="{{ asset(env('UPLOAD_PATH').'/' . $property->photo) }}" target="_self">
                           ...
                           @if ($property->inquilinos()->count() > 0 && $property->unidades()->count() > 0)
                            <div class="control-block-button post-control-button"  style="float:left;z-index:5000000" >
                                <a href="{{route('admin.properties_sub.unidades_consulta',[$property->id])}}" class="btn btn-control featured-post" style="width:76px;padding-top:7px;background:#41a541;margin-top: -91px;border-radius:4px;padding-right: 15px;padding-left: 8px; border:2px solid #fff" data-toggle="tooltip" title="Nivel de ocupación: {{number_format($property->inquilinos()->count()/$property->unidades()->count()*100)}}%">
                                    <div class="title"><h5>Ocupada</h5></div>
                                </a>
                            </div>

             <!--                <div class="control-block-button post-control-button"  style="float:left;z-index:5000000" >
            <a target="_self" href="{{route('admin.properties_seguros.show',[$property->id_seguro])}}" class="btn btn-control featured-post" style="z-index:5000000;width:126px;padding-top:7px;background:#33435a;margin-top: -61px;border-radius:4px;padding-right: 15px;padding-left: 8px; border:2px solid #fff;z-index:5000000" data-toggle="tooltip" title="">
                <div class="title">
                    <h5>Con Seguro</h5>
                </div>
            </a>
    ...
    @can('properties_seguros_edit')
        <div class="control-block-button post-control-button"  style="float:left;z-index:5000000" >
            <a target="_self" href="{{route('admin.properties_seguros.show',[$property->seguros->id])}}" class="btn btn-control featured-post" style="z-index:5000000;width:126px;padding-top:7px;background:#33435a;margin-top: -61px;border-radius:4px;padding-right: 15px;padding-left: 8px; border:2px solid #fff;z-index:5000000" data-toggle="tooltip" title="">
                <div class="title">
                    <h5>Con Seguro</h5>
                </div>
            </a>
    ...
    @can('properties_seguros_view')
          ...
          <div class="control-block-button post-control-button"  style="float:left;z-index:5000000" >
            <a target="_self" href="{{route('admin.properties_seguros.show',[$property->seguros->id])}}" class="btn btn-control featured-post" style="z-index:5000000;width:126px;padding-top:7px;background:#33435a;margin-top: -41px;border-radius:4px;padding-right: 15px;padding-left: 8px; border:2px solid #fff;z-index:5000000" data-toggle="tooltip" title="">
                <div class="title">
                    <h5>Con Seguro2</h5>
                </div>
            </a>
   ...
   @endif-->
                            ...
                            <div class="control-block-button post-control-button"  style="float:right;z-index:5000000" >
                                <a href="{{ route('admin.properties_facturas.facturas_propiedad_consulta',[$property->id]) }}" class="btn btn-control featured-post" style="width:120px;padding-top:9px;background:#41a541;margin-top: -91px;border-radius:4px;"data-toggle="tooltip" title="Pagos al dia ${{number_format($property->facturas_pagadas_propiedad($property->id)), 0, ',', '.'}}">
                            ...
                            <div class="control-block-button post-control-button"  style="float:right;z-index:5000000" >
                                <a href="{{ route('admin.properties_facturas.facturas_propiedad_consulta',[$property->id]) }}" class="btn btn-control featured-post" style="width:120px;padding-top:9px;background:#e66a6a;margin-top:-91px;border-radius:4px;"data-toggle="tooltip" title="Por recaudar">
                                    <div class="title"><h5>Balance
                      ...
                      <!--    @if($property->valor_recaudo($property->id)> 0)
       
                            <div class="control-block-button post-control-button"  style="float:right;" >
                                <a href="{{ route('admin.properties_facturas.facturas_propiedad_consulta',[$property->id]) }}" class="btn btn-control featured-post" style="width:120px;padding-top:9px;background:#347ca4;margin-top:-91px;border-radius:4px;"data-toggle="tooltip" title="Por recaudar">
                                    <div class="title"><h5>
                                        ${{(number_format($property->valor_recaudo($property->id)+$property->valor_vencido($property->id))), 0, ',', '.'}}</h5></div>
                                </a>
           ...
           <!-- <a target="_self" href="{{ route('admin.properties_propietarios.index',[$property->id]) }}" class="btn btn-control featured-post" style="width:100%;padding-top:7px;background:rgba(104,111,219,.2);color:#262d9e;margin-top:0px;border-radius:4px;padding-right: 15px;padding-left: 8px; border:2px solid rgba(104,111,219,.2);z-index:6000000;border-radius: 100px;font-family: proxima-nova,Avenir,sans-serif;letter-spacing: 0;font-weight: 600;" data-toggle="tooltip" title="Ver Informes">
            ...
            @endif
                            ...
                            <div class="control-block-button post-control-button"  style="float:left" >
                                <a href="#" class="btn btn-control featured-post" style="width:66px;padding-top:9px;background:#41a541;">
                                    <div class="title"><h5>Ocupada</h5></div>
                                </a>
                            </div>
                             @endif
                            ...
                            @if ($property->facturas_valor($property->id)-$property->facturas_pagadas_propiedad($property->id) == 0 )
                            <div class="control-block-button post-control-button"  style="float:right;" >
                                <a href="{{ route('admin.properties_facturas.facturas_propiedad_consulta',[$property->id]) }}" class="btn btn-control featured-post" style="width:66px;padding-top:9px;background:#41a541;"data-toggle="tooltip" title="Pagos al dia">
                                    <div class="title"><h5>${{number_format($property->facturas_valor($property->id)-$property->facturas_pagadas_propiedad($property->id)), 0, ',', '.'}}</h5></div>
                                </a>
                            </div>
                             @endif
                              ...
                              @if ($property->facturas_valor($property->id)-$property->facturas_pagadas_propiedad($property->id) > 0)
                            <div class="control-block-button post-control-button"  style="float:right;" >
                                <a href="{{ route('admin.properties_facturas.facturas_propiedad_consulta',[$property->id]) }}" class="btn btn-control featured-post" style="width:66px;padding-top:9px;background:#e66a6a;"data-toggle="tooltip" title="Valor Vencido">
                                    <div class="title"><h5>${{number_format($property->facturas_valor($property->id)-$property->facturas_pagadas_propiedad($property->id)), 0, ',', '.'}}</h5></div>
                                </a>
                            </div>
                             @endif
                            ...
                            <div class="control-block-button post-control-button" >
                                <a href="#" class="btn btn-control featured-post" style="width:76px;padding-top:9px;background:#e66a6a;">
                                    <div class="title"><h5>Por ocupar</h5></div>
                                </a>
                            </div>
                            @endif-->
                        ...
                        <div class="swiper-container" data-slide="fade" style="padding-bottom:3px;overflow: unset;">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    ...
                                    <!--<div class="control-block-button post-control-button" style="margin-top:20px;
                                    float: right;margin-bottom:140px;" >
                                        @can('property_view')
                                            <a href="{{ route('admin.properties.show',[$property->id]) }}" class="btn btn-xs btn-primary">
                                                <div class="title"><h5>@lang('global.app_view')</h5>
                                                </div>
                                            </a>
                                        @endcan
                                    </div>-->
