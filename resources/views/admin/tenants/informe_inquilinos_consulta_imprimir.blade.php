...
.m-status-2 {
 ...
 <a href="{{ route('landing.index') }}" class="main-logo"><img src="{{asset('/css/imagenes/logo-colhouse.png')}}" alt="Colhouse" style="width: 215px;padding-left: 25px;padding-top: 20px;" /></a>
