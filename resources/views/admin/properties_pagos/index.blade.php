                            ...
                            <tr data-entry-id="{{ $pago->id }}">
                               <!-- @can('properties_pagos_delete')
                                ...
                                @endcan-->
                                 ...
                                 <td field-key='property'>COLH-FT-{{ $pago->id_factura or '' }}<br/>
                                    Inicio: {{date('d/F/Y', strtotime($pago->factura->fecha_inicio))}}<br/>
                                    Vencimiento: {{date('d/F/Y', strtotime($pago->factura->fecha_corte))}}<br/>
                                    Valor factura: ${{number_format($pago->factura->valor_neto)}}
