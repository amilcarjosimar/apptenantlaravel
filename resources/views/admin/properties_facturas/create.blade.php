        ...
        <div class="panel-body">
            ...
            <div class="row" style="padding:10px;">
                    ...
                    <div  style="border:1px solid #000;padding:10px;background-color:#d4edda;margin-bottom:10px;border-radius:5px">Unidad:
                        <h3><b>{{$properties->nombre}}</b></h3>
                    </div>
                    <div  style="border:1px solid #000;padding:10px;background-color:#e66a6a;margin-bottom:10px;border-radius:5px;color:#fff" data-toggle="tooltip" data-html="true" title="Valor base arrendamiento">Valor factura:
                   <!-- <h3><b>${{number_format($properties->renta), 0, ',', '.'}}</b></h3>-->

                      <input type="text" name="property_renta" value="{{$properties->renta}}" id="property_renta" style="color: #fff;font-size: 26px;padding:2px">
...
document.getElementById("valor_neto").value=resultado;
}
</script>
