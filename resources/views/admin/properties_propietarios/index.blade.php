    ...
    <div class="modal-content">
        ...
        <div class="modal-header">
          <!--  <p class="heading lead">{{ trans('messages.modaltitledemo') }}</p>-->
            <p class="heading lead">Editar deducción</p>

            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true" class="white-text">&times;</span>
            </button>

             <input type="text" name="fechadeduccion" value="<?=$property->propietarios2($property->id)->id;?>" id="fechadeduccion">

              {!! Form::label('fecha_deduccion1', 'Fecha deducción', ['class' => 'control-label']) !!}
                                        {!! Form::date('fecha_deduccion1', old('fecha_deduccion1'), ['class' => 'form-control', 'placeholder' => 'Fecha deducción', 'required' => '']) !!}
                                        <p class="help-block"></p>
                                        @if($errors->has('fecha_deduccion1'))
                                            <p class="help-block">
                                                {{ $errors->first('fecha_deduccion1') }}
                                            </p>
                                        @endif
