  ...
  <div class="intro intro-carousel">
    ...
    <div class="carousel-item-a intro-item bg-image" style="background-image: url(landing/assets/img/slide-1.jpg)">
      <!--<div class="carousel-item-a intro-item bg-image"
         style="background-image:url({{ ($property->propiedad->photo)}})">-->
              ...
              <div class="row">
                <div class="col-lg-8" style="margin-top:-10px;">
                  <div class="intro-body">
                    <!--<h3 class="intro-title-top">{{$property->propiedad->ciudad->ciudad}}
                      <br> Norte
                    </h3>-->
                    ...
                    <h3>
                      <span class="color-b" style="color:#ffffff;-webkit-text-stroke: 2px #fff;">{{$property->propiedad->ciudad->ciudad}}
                      </span>
                    </h3>
          ...
          <div class="col-md-12">
            <div class="title-wrap d-flex justify-content-between">
              <div class="title-box" style="padding-top:52px">
                <h2 class="title-a">Propiedades disponibles</h2>
              </div>
              ...
              <div class="carousel-item-b" style="margin-bottom:31px;border-radius:7px;">
                      <div class="card-box-a card-shadow" style="border-radius:7px;">
                        <div class="img-box-a" style="background-size:contain;border-radius:7px;">
                          <a href="{{ asset(env('UPLOAD_PATH').'/' . $property->propiedad->photo) }}" target="_blank">
                          <img src="{{ asset(env('UPLOAD_PATH').'/' . $property->propiedad->photo) }}" alt="" class="img-a img-fluid" style="background-size:contain;width: 389px;
                          ...
                          <div class="card-overlay-a-content" style="margin-bottom:53px;">
                            <div class="card-header-a" style="margin-top:20px;">
                              <h2 class="card-title-a">
                                ...
                                <!-- {{$loop->iteration}}-->
                                  {{$property->nombre}}
                                  <br /> {{$property->propiedad->name}}</a>
                                  <br/>
                                  <h4 class="card-title-a" style="color:#fff;font-size:18px;line-height:20px">{{$property->propiedad->address}}</h4>
                            ...
                            <div class="card-body-a" style="margin-top:30px">
                             <!-- <div class="price-box d-flex" style="float: right;">
                                 <a href="{{ asset(env('UPLOAD_PATH').'/' . $property->propiedad->photo) }}" class="link-a" target="_blank"><span class="price-a">Ver detalles</span></a>
                              </div>-->
                        ...
                        @foreach ($properties as $property)
                            ...
                            <tr data-entry-id="{{ $property->id }}">
                                ...
                                <td field-key='unidad' data-toggle="tooltip" title="" style="font-size: 12px;">
                                     ...
                                     <a href="{{ route('admin.properties_sub.show',[$property->id]) }}">{{ $property->nombre }}
                                     </a>
                                ...
                                <td field-key='tipo'>{{ $property->tipo_propiedad_sub->tipo }}<br/>
                                  Dirección: {{ $property->propiedad->address }}</td>
                                ...
                                <td style="padding-top:20px ;">
                                 ...
                                 <!-- 
                                    <a href="{{ route('admin.properties_sub.show',[$property->id]) }}" class="btn btn-xs btn-primary" target="_blank">Ver unidad
                                     ...
                                     <a href="{{ asset(env('UPLOAD_PATH').'/' . $property->propiedad->photo) }}" class="btn btn-xs btn-primary" target="_blank">Ver unidad
                                     </a>
