    ...
    <section class="intro-single">
      <div class="container">
        ...
        <div class="row">
                ...
                <span class="color-text-a">¿Estás interesado en esta Propiedad?</span>
                <a href="#contacto">
                  <span class="m-status" style="margin-top:-2px;margin-left: 3px">
                     Por favor registra el formulario abajo
                  </span>
                </a>
              ...
              <div class="carousel-item-b" style="margin-bottom:31px;border-radius:7px;">
                      <div class="card-box-a card-shadow" style="border-radius:7px;">
                        <div class="img-box-a" style="background-size:contain;border-radius:7px;">
                          ...
                          <img src="{{ asset(env('UPLOAD_PATH').'/' . $unidad->propiedad->photo) }}" alt="" class="img-a img-fluid" style="background-size:contain;width: 389px;
              ...
              <div class="col-md-7">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                      <div class="form-group">
                        <input type="text" id="content"name="subject" class="form-control form-control-lg form-control-a" placeholder="Detalles" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject">
                        <div class="validate"></div>
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                        <textarea  id="content" name="content" class="form-control"  cols="45" rows="8" data-rule="required" data-msg="Please write something for us" placeholder="Mensaje"></textarea>
                        <div class="validate"></div>
                      </div>
                    </div>
                    <div class="col-md-12 mb-3">
